...
var iterZeta = require( './../lib' );


// VARIABLES //

var rand = randu( 1.1, 50.0 );
...
tape( 'main export is a function', function test( t ) {
	...
	t.equal( typeof iterZeta, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object (value+done)', function test( t ) {
	...
	it = iterZeta( createIterator( values ) );
	t.equal( it.next.length, 0, 'has zero arity' );
...
tape( 'the function returns an iterator protocol-compliant object which evaluates the Riemann zeta function for each iterated value', function test( t ) {
	var expected;
	var rand;
	var it;
	var N;
...
tape( 'the function returns an iterator protocol-compliant object which evaluates the Riemann zeta function for each iterated value (value+done)', function test( t ) {
	var expected;
	var actual;
	var values;
	var it;
